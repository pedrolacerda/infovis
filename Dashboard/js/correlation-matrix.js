...
var correlationSvg = d3.select("#correlation").append("svg")
    .attr("width", corMtxwidth + corMtxMargin.left + corMtxMargin.right)
    .attr("height", corMtxHeight + corMtxMargin.top + corMtxMargin.bottom)
    .style("margin-left", corMtxMargin.left + "px")
  .append("g")
...
d3.json("file:///C:/Users/Pedro/Documents/GitHub/infovis/Dashboard/data/correlation-matrix.json", function(miserables) {
  ...
  correlationSvg.append("rect")
      ...
      .attr("width", corMtxwidth)
      .attr("height", corMtxHeight);

  var row = correlationSvg.selectAll(".row")
      .data(matrix)
    .enter().append("g")
      .attr("class", "row")
  ...
  var column = correlationSvg.selectAll(".column")
      .data(matrix)
    .enter().append("g")
      .attr("class", "column")
  ...
  function order(value) {
    ...
    var t = correlationSvg.transition().duration(2500);
